		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice accident states do not exist!', statusCode: 404, detail: 'practice accident states do not exist!', repo: 'aquila-api', path: '/api/v1/practice_accident_states/:practice_id' });
