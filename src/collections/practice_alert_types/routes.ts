		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice alert types do not exist!', statusCode: 404, detail: 'practice alert types do not exist!', repo: 'aquila-api', path: '/api/v1/practice_alert_types/:practice_id' });
