		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice provider specialities do not exist!', statusCode: 404, detail: 'practice provider specialities do not exist!', repo: 'aquila-api', path: '/api/v1/practice_provider_specialities/:practice_id' });
