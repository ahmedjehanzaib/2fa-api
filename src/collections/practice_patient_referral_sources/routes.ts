		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice patient referral sources do not exist!', statusCode: 404, detail: 'practice patient referral sources do not exist!', repo: 'aquila-api', path: '/api/v1/practice_patient_referral_sources/:practice_id' });
