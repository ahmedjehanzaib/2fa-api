		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice financial visit statuses do not exist!', statusCode: 404, detail: 'practice financial visit statuses do not exist!', repo: 'aquila-api', path: '/api/v1/practice_financial_visit_statuses/:practice_id' });
