		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice payment types do not exist!', statusCode: 404, detail: 'practice payment types do not exist!', repo: 'aquila-api', path: '/api/v1/practice_payment_types/:practice_id' });
