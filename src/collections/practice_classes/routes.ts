		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice classes do not exist!', statusCode: 404, detail: 'practice classes do not exist!', repo: 'aquila-api', path: '/api/v1/practice_classes/:practice_id' });
