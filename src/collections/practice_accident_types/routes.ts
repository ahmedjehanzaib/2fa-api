		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice accident types do not exist!', statusCode: 404, detail: 'practice accident types do not exist!', repo: 'aquila-api', path: '/api/v1/practice_accident_types/:practice_id' });
