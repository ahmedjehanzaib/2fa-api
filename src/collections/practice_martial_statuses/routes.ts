		...
		try {
			...
			if (validated.error === null) {
				...
				if (!data.length) {
					...
					log.warn({ message: 'practice martial statuses do not exist!', statusCode: 404, detail: 'practice martial statuses do not exist!', repo: 'aquila-api', path: '/api/v1/practice_martial_statuses/:practice_id' });
