...
const validationSchema = {
    ...
    createAPractice: {
        ...
        body: {
            ...
            special_security_number: JOI.string().trim().optional().allow('', null),
            ...
            location: JOI.object().keys({
                ...
                national_provider_identity: JOI.string().trim().required(),
                tax_id: JOI.string().trim().required(),
                clia_number: JOI.string().trim().allow('', null),
                contact_person: JOI.string().trim().allow('', null),
    ...
    createAProvider: {
        ...
        body: {
            ...
            license_number: JOI.string().trim().optional().allow('', null),
            notes: JOI.string().trim().optional().allow('', null),
            active: JOI.number().min(0).max(1).optional().allow(null),
