...
function locationRouters() {
    ...
    router.get('/:id', function (req, res, _next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        var validated, location_1, err_2;
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 1:
                    ...
                    if (!location_1.length) {
                        ...
                        res.status(200).json({ data: location_1[0], error: null, message: 'practice location fetched successfully!' });
                    }
                    return [3, 3];
                case 2:
                ...
                case 4:
                    err_2 = _a.sent();
                    log_1.log.error({ message: 'Error in finding a practice location!', statusCode: 500, detail: err_2, repo: 'aquila-api', path: '/api/v1/locations/:id' });
                    res.status(500).json({ data: null, error: err_2, message: 'Error in finding a practice location!' });
                    return [3, 5];
                case 5: return [2];
            }
        });
    ...
    router.delete('/:id', function (req, res, _next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    err_3 = _a.sent();
                    log_1.log.error({ message: 'Error in deleting a practice location!', statusCode: 500, detail: err_3, repo: 'aquila-api', path: '/api/v1/locations/:id' });
                    res.status(500).json({ data: null, error: err_3, message: 'Error in deleting a practice location!' });
                    return [3, 8];
                case 8: return [2];
            }
        });
    ...
    router.put('/:id', function (req, res, _next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    err_4 = _a.sent();
                    log_1.log.error({ message: 'Error in updating a practice location!', statusCode: 500, detail: err_4, repo: 'aquila-api', path: '/api/v1/locations/:id' });
                    res.status(500).json({ data: null, error: err_4, message: 'Error in updating a practice location!' });
                    return [3, 8];
                case 8: return [2];
            }
        });
