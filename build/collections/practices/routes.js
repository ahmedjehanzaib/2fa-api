...
exports.practicesRouter = void 0;
    ...
    router.get('/:id', function (req, res, _next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                    validated = JOI.validate({ params: req.params }, validation_1.validationSchema.findPractice);
                    if (!(validated.error === null)) return [3, 2];
                    return [4, facade_1.practicesFacade.findPracticeById(req.params.id)];
                case 1:
                    client = _a.sent();
                    if (!client.length) {
                        log_1.log.warn({ message: 'Practice does not exist!', statusCode: 404, detail: 'Practice does not exist!', repo: 'aquila-api', path: '/api/v1/practices/:id' });
                        res.status(404).json({ data: null, error: true, message: 'Practice does not exist!' });
                    }
                    else {
                        res.status(200).json({ data: client, error: null, message: 'practice fetched successfully!' });
                    }
                    return [3, 3];
                case 2:
                    log_1.log.warn({ message: validated.error.details[0].message, statusCode: 400, detail: validated.error.details[0], repo: 'aquila-api', path: '/api/v1/practices/:id' });
                    res.status(400).json({ data: null, error: true, message: validated.error.details[0].message });
                    _a.label = 3;
                case 3: return [3, 5];
                case 4:
    ...
    router.put('/:id', function (req, res, _next) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
        ...
        return tslib_1.__generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 7, , 8]);
                    validated = JOI.validate({ params: req.params, body: req.body }, validation_1.validationSchema.updateAPractice);
                    if (!(validated.error === null)) return [3, 5];
                    return [4, facade_1.practicesFacade.findPracticeById(req.params.id)];
                case 1:
                    practice = _a.sent();
...
exports.practicesRouter = practicesRouter;
;
